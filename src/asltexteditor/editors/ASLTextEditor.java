...
//import org.eclipse.ui.examples.javaeditor.JavaEditor.DefineFoldingRegionAction;
import org.eclipse.ui.texteditor.ITextEditor;
import org.eclipse.ui.texteditor.TextEditorAction;
//import org.eclipse.ui.views.contentoutline.IContentOutlinePage;

public class ASLTextEditor extends TextEditor {
...
/*
	public ASLTextEditor() {
		super();
		colorManager = new ColorManager();
		setSourceViewerConfiguration(new ASLSourceViewerConfiguration(colorManager));
...
*/	
	...
	protected void createActions() {
		super.createActions();
		System.out.println(ASLEditorMessages.getResourceBundle());
		IAction a= new DefineFoldingRegionAction(ASLEditorMessages.getResourceBundle(), "DefineFoldingRegion.", this); //$NON-NLS-1$
	...
	protected void initializeEditor() {
		...
		setSourceViewerConfiguration(new ASLSourceViewerConfiguration(this.colorManager));
	}
